...
public class Lab {
     ...
     */
    public boolean returnBoolean(boolean b){if(b == true){return true; }
        return false;
    }
     ...
     */
    public boolean returnNot(boolean b){if(b == true){return false;}
        return true;
    }
     ...
     * look into boolean operations to do this without using if/else statements.
     */
    public boolean returnAnd(boolean b1, boolean b2){if(b1 && b2== true){return true;}
        return false;
    }
     ...
     * look into boolean operations to do this without using if/else statements.
     */
    public boolean returnOr(boolean b1, boolean b2){if(b1||b2 == true){return true;}
        return false;
    }
